...
//		createNewRtmToRosLink<TimedLong, std_msgs::Int32>("inPort1", &convert3);
	...
	void Gateway::createNewRtmToRosLink(const std::string& name, boost::function2<void, const RtmType&, RosType&> convertFn) {
	 ...
	 */
	template<class RtmType, class RosType>
	void Gateway::copyFromRtcToRos(RtmToRosLink<RtmType>* link, boost::function2<void, const RtmType&, RosType&> convertFn) {
